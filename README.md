...
**VSP-channel transactions are excluded from this dashboard by standing request.** Of 5,571 valid transactions in the DAILY TRANSACTIONS tab, 99 tagged with the VSP channel were removed, leaving **5,472 transactions** that power every number on this page.
